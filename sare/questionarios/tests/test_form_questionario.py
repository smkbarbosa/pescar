...
class QuestionarioPessoalTest(TestCase):
    ...
    def setUp(self):
        self.form = QuestionarioPessoalForm()
...
class QuestionarioSocialTest(TestCase):
    def setUp(self):
        self.form = QuestionarioSocialForm()
...
class QuestionarioCulturalTest(TestCase):
    def setUp(self):
        self.form = QuestionarioCulturalForm()
...
class QuestionarioAmbientalTest(TestCase):
    def setUp(self):
        self.form = QuestionarioAmbientalForm()
...
class QuestionarioFinalTest(TestCase):
    def setUp(self):
        self.form = QuestionarioFinalForm()
