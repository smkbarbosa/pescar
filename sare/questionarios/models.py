...
class Questionario(models.Model):
    ...
    # origem_renda = models.IntegerField(null=True, max_length=10)
    # renda_bruta_domiciliar = models.FloatField(null=True)
    # responsavel_domicilio = models.CharField(null=True)
    #
    # # Finanças
    ...
    #     (5, 'de 0 até 234, 24')
    # ]
    # renda_per_capita = models.CharField(null=True, choices=RENDA_PER_CAPITA_CHOICE)
    #
    ...
    #     (5, 'Desempregado')
    # ]
    # condicao_responsavel_casa = models.CharField(null=True, choices=CONDICAO_RESPONSAVEL_CASA_CHOICES)
    #
    ...
    # ]
    # meio_acesso_campus = models.CharField(null=True, choices=MEIO_ACESSO_CAMPUS_CHOICES)
    #
    ...
    # ]
    #
    # pne_parcial_visao_audicao = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # pne_def_fisica = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # pne_total_visao_audicao = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # pne_def_mental_leve = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # pne_def_mental_grave = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    #
    # psico_dificuldade_concentrar = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # psico_conflito_familiar = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # psico_depressao = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    #
    # ## Cultural
    #
    # COR_RACA_CHOICES = [
    ...
    # ]
    #
    # violencia_verbal = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_urbana = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_patrimonial = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_cyberbulling = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_religiosa = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_assedio_moral = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_abandono = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_abuso_familiar = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_atentado_pudor = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_trafico_humano = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_psicologica_moral = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_fisica = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # violencia_sexual = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    #
    # PRECONCEITO = [
    #     'Cultural',
    #     'Estético',
    ...
    # ]
    #
    # preconceito_cultural = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # preconceito_estetico = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # preconceito_economico = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # preconceito_religioso = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # preconceito_mental = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # preconceito_racial = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # preconceito_genero = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    # preconceito_orientacao_sexual = models.CharField(null=True, choices=VOCE_FAMILIA_CHOICES)
    #
    ...
    #
    # fale_mais_familia = models.CharField(null=True, )