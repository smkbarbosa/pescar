# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-04-13 16:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ambiental', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dimensao_ambiental', to='questionarios.DimensaoAmbiental')),
                ('cultural', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dimensao_cultural', to='questionarios.DimensaoCultural')),
                ('economica', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dimensao_economica', to='questionarios.DimensaoEconomica')),
                ('social', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dimensao_social', to='questionarios.DimensaoSocial')),
            ],
            options={
