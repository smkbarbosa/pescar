...
class EntrevistaForm(forms.ModelForm):
    ...
    sp_1 = forms.ChoiceField(label='Dependente financeiro e sofre algum tipo de violência do responsável pelo seu '
                                   'sustento', widget=forms.RadioSelect(attrs={'class':'inline', }), choices=number_choices)
