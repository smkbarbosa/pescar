...
class Entrevista(models.Model):
    ...
    cl_1 = models.BooleanField('Cópia Legí vel do RG e CPF do candidato', default=False)
    cl_2 = models.BooleanField('Cópia Legí vel do RG e CPF do responsável legal (caso o candidato seja menor de idade)', default=False)
